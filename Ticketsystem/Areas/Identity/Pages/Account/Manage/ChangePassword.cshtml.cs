...
namespace Ticketsystem.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("NewPassword", ErrorMessage = "Die eingegebenen Passwörter stimmen nicht überein.")]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Kann Benutzer mit ID '{_userManager.GetUserId(User)}' nicht laden.");
            }
